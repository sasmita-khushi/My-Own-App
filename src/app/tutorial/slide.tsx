...
function Slider() {
  ...
  return (
    <Holder
      className=" bg-blue-400  rounded-full relative  mb-10 justify-center items-center overflow-hidden "
      style={[
        {
          width: BOX_WIDTH,
          height: BOX_HEIGHT,
    ...
    >
      <Animated.Text
        className=" text-lg ml-9 absolute "
        style={[textAnimeStyle]}
      >
        Slide to answer Call
      </Animated.Text>
      <GreenBox
        className=" bg-white rounded-full absolute left-0 top-0"
      ...
      >
        <GestureDetector gesture={gesture}>
          <Circle
            ...
            className=" bg-blue-400 absolute  left-0 top-0  justify-center items-center"
          >
            <InnerCircle
              className=" bg-blue-200 absolute rounded-full justify-center items-center"
